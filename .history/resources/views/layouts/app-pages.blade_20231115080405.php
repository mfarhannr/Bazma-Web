...
<body class="about-us bg-gray-200">
    ...
    <!--   Core JS Files   -->
    <script src="./pages/js/core/popper.min.js" type="text/javascript"></script>
    <script src="./pages/js/core/bootstrap.min.js" type="text/javascript"></script>
    <script src="./pages/js/plugins/perfect-scrollbar.min.js"></script>
    <!--  Plugin for TypedJS, full documentation here: https://github.com/inorganik/CountUp.js -->
    <script src="./pages/js/plugins/countup.min.js"></script>
    <!-- Control Center for Material UI Kit: parallax effects, scripts for the example pages etc -->
    <!--  Google Maps Plugin    -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDTTfWur0PDbZWPr7Pmq8K3jiDp0_xUziI"></script>
    <script src="./pages/js/material-kit.min.js?v=3.0.4" type="text/javascript"></script>
    <script>
