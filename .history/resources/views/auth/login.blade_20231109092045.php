                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-dark h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://smktibazma.sch.id/static/media/hero-1.2803f83852406277b6cd.jpg');background-size: cover;">
                                <span class="mask bg-gradient-dark opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">SMK TI Bazma</h4>
                                <p class="text-white position-relative">Buat Website Lebih menarik dan dinam</p>
                            </div>
                        </div>
                    </div>
                </div>
