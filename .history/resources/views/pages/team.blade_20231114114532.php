...
@section('content')
    ...
    <header class="bg-gradient-dark">
      <div class="page-header min-vh-75" style="
            background-image: url('./pages//pages/assets/img/examples/asrama.jpg');
          ">
                    ...
                    <a href="javascript:;">
                      <div class="position-relative">
                        <div class="blur-shadow-image">
                          <img class="w-100 border-radius-lg shadow-lg" src="/pages/assets/img/team-2.jpg">
                        </div>
                      </div>
                    </a>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <a href="javascript:;">
                      <div class="position-relative">
                        <div class="blur-shadow-image">
                          <img class="w-100 border-radius-lg shadow-lg" src="/pages/assets/img/team-4.jpg"
                            alt="profile image">
                        </div>
                      </div>
                    </a>
                      ...
                      <div class="position-relative">
                        <div class="blur-shadow-image">
                          <img class="w-100 border-radius-lg shadow-lg"
                            src="/pages/assets/img/team-5.jpg">
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-lg-5">
                    <a href="javascript:;">
                      <div class="position-relative">
                        <div class="blur-shadow-image">
                          <img class="w-100 border-radius-lg shadow-lg"
                            src="/pages/assets/img/team-3.jpg">
                        </div>
                      </div>
                    </a>
                  </div>
