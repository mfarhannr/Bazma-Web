    ...
    <div class="row">
          ...
          <div class="card card-plain">
            <div class="card-header p-0 position-relative">
              <a class="d-block blur-shadow-image" href="./pages/assets/tampilan/arif.html" >
                <img src="./pages/assets/foto/arya.png" alt="img-blur-shadow" class="hover-img img-fluid border-radius-lg" loading="lazy" >
              </a>
            </div>
            <div class="card-body px-0">
              <h5>
                <a href="./pages/assets/tampilan/arif.html" class="text-dark font-weight-bold">A. Fauzan Arif H.</a>
              </h5>
              <p>
                UI/UX Designer
              </p>
        ...
        <div class="card card-plain">
          <div class="card-header p-0 position-relative">
            <a class="d-block blur-shadow-image" href="./pages/assets/tampilan/ahmad.html">
              <img src="./pages/assets/foto/arya.png" alt="img-blur-shadow" class="img-fluid border-radius-lg" loading="lazy">
            </a>
          </div>
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/ahmad.html" class="text-dark font-weight-bold">Ahmad Sibgatullah L.</a>
            </h5>
            <p>
              Graphic Designer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="graphic-designer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/arya.html" class="text-dark font-weight-bold">Ardian Arya Putra</a>
            </h5>
            <p>
              Graphic Designer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="graphic-designer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/bayu.html" class="text-dark font-weight-bold">Bayu Bagaskara</a>
            </h5>
            <p>
              Graphic Designer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/bintang.html" class="text-dark font-weight-bold">Bintang Riski Sulistio</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/firman.html" class="text-dark font-weight-bold">Firmansyah</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="graphic-designer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/hafis.html" class="text-dark font-weight-bold">Hafiz Alfitrah</a>
            </h5>
            <p>
              Graphic Designer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/hamidzan.html" class="text-dark font-weight-bold">Hamidzan P.B</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="ui-ux-designer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/reski.html" class="text-dark font-weight-bold">Muhammad Rizqi</a>
            </h5>
            <p>
              UI/UX Designer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/ilham.html" class="text-dark font-weight-bold">Ilham Alfiansyah</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/alam.html" class="text-dark font-weight-bold">M. Alamsyah</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/frahan.html" class="text-dark font-weight-bold">Muhammad Farhan</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/fikri.html" class="text-dark font-weight-bold">M. Maulana Fikri</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/syahru.html" class="text-dark font-weight-bold">Muhammad Syahru</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/nabil.html" class="text-dark font-weight-bold">Nabil Rabbani</a>
            </h5>
            <p>
              Web Developer
            </p>
      ...
      <div class="itemBox col-lg-3 col-sm-6" data-item="web-developer">
        <div class="card card-plain">
          ...
          <div class="card-body px-0">
            <h5>
              <a href="./pages/assets/tampilan/husen.html"  class="text-dark font-weight-bold">Vincent Rahadian U.</a>
            </h5>
            <p>
              Web Developer
            </p>
